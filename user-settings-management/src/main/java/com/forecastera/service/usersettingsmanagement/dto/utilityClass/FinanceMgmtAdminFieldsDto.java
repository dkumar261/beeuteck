...
@Getter
@Setter
public class FinanceMgmtAdminFieldsDto {
    ...
    private List<PicklistFormat> adminPicklistSettingsList;
    ...
    public FinanceMgmtAdminFieldsDto(FinanceMgmtFieldMap financeMgmtFieldMap){
