...
import com.forecastera.service.financialmanagement.commonResponseUtil.Error;
...
public class CustomExceptionHandler {
    ...
    protected ResponseEntity<Error> handleMainExceptions(BadRequestException ex, HttpServletRequest request, HttpServletResponse response) {
