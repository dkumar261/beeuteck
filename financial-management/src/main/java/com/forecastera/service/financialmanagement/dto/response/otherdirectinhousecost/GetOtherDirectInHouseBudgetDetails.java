...
@AllArgsConstructor
@Data
public class GetOtherDirectInHouseBudgetDetails {

    @JsonProperty("Other Direct In House Cost Budget Details Id")
    private Integer other_direct_inhouse_cost_budget_id;
