...
@AllArgsConstructor
@Data
public class GetRequestedResourcesDataForString {
...
//    private BigDecimal requested_fte;
 ...
 //   private List<AllResourceActiveAllocation> allocations;
    ...
    private String show_bold;

    public GetRequestedResourcesDataForString(GetRequestedResourcesDataForString getRequestedResourcesData){
        ...
        this.notify =getRequestedResourcesData.getNotify();
        this.show_bold =getRequestedResourcesData.getShow_bold();
